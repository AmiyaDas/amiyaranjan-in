...
new stepsForm(theForm, {
  onSubmit: function (form) {
    ...
    var link =
      "https://docs.google.com/forms/d/e/1FAIpQLSd1JpwNaH-iBJ80_9PvKD3zPXbIGor10O6msHvIIP1MRgfbcw/formResponse";
    jQuery.ajax({
      url: link,
      data: {
        "entry.2111170142": $("#q2").val(),
        "entry.2040235095": $("#q3").val(),
        "entry.72030663": $("#q1").val(),
      },
      type: "POST",
      dataType: "xml",
      crossDomain: true,
  ...
  function numberAnimations() {
    $(window).scroll(function () {
      if ($(".numbers-wrapper").is(":visible") == true) {
        ...
        $("#coded-lines").animateNumber(
          { number: 160359, numberStep: comma_separator_number_step },
          2000
        );
        $("#rendered-pixels").animateNumber(
          { number: 783, numberStep: comma_separator_number_step },
          2000
        );
        $("#coffee-cups").animateNumber(
          { number: 1512, numberStep: comma_separator_number_step },
          2000
        );
        $("#eaten-nutela").animateNumber(
          { number: 26, numberStep: comma_separator_number_step },
          2000
        );
...
var skills = [
  {
    header: "INTERESTS",
    captions: ["Digital Marketing", "Web", "PWAs", "Design", "SEO"],
    values: [0.8, 0.9, 0.7, 0.8, 0.9],
  },
  {
    header: "CORE",
    captions: ["CSS", "AJAX", "HTML", "jQuery", "JS"],
    values: [0.9, 0.7, 0.9, 0.7, 0.8],
  },
  {
    header: "Mordern Web",
    captions: ["Vue", "FusionJs", "React", "Angular", "Weex"],
